...
const scrapbookCardSchema = z.object({
  ...
  source_favicon: z.string(),
  event_date: z.string().nullable(),
  event_date_precision: z.enum(["exact", "approximate", "unknown"]),
  relevance: z.enum(["high", "medium", "low"]),
  answer_relevance: z.enum(["direct", "tangential", "background"]),
  is_about_target: z.boolean(),
...
const bodySchema = z.object({
  ...
  pin_target: z.enum(["signal", "dossier_hook", "note"]),
