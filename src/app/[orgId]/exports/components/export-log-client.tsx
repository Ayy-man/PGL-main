              ...
              return (
                <div key={entry.id} className="p-4 space-y-1.5">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {entry.target_id ? (
                      <button
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-[8px] transition-colors cursor-pointer shrink-0"
                        style={{
                          color: "var(--text-tertiary)",
                  ...
                  <div className="flex items-center gap-3 text-xs" style={{ color: "var(--text-tertiary)" }}>
                    <span className="font-mono">{formatTimestamp(entry.created_at)}</span>
                    <span>
                      {typeof memberCount === "number"
                        ? `${memberCount.toLocaleString()} rows`
                        : `${String(memberCount)} rows`}
                    </span>
